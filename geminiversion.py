...
if uploaded_files:
    ...
    if prompt := st.chat_input("What is your Advantage Software question or comment?"):
        ...
        with st.chat_message("assistant"):
            response = client.models.generate_content(model="gemini-2.0-flash", contents=[prompt], config=types.GenerateContentConfig(max_output_tokens=3000, temperature=1 , system_instruction=raw_text,))
